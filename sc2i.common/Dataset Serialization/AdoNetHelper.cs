...
namespace sc2i.common
{
	...
	public class AdoNetHelper
	{
		...
		public static byte[] SerializeTypedDataTable(DataTable dataTable)
		{
            ...
            using (FastSerializer serialiser = new FastSerializer())
            {
                return serialiser.SerializeDataOnly(dataTable);
            }
		}
		...
		public static byte[] SerializeTypedDataSet(DataSet dataSet)
		{
            ...
            using (FastSerializer serialiser = new FastSerializer())
            {
                return serialiser.SerializeDataOnly(dataSet);
            }
		}
		...
		public static byte[] SerializeDataSet(DataSet dataSet)
		{
            ...
            using (FastSerializer serialiser = new FastSerializer())
            {
                return serialiser.Serialize(dataSet);
            }
		}
		...
		public static byte[] SerializeDataTable(DataTable dataTable)
		{
            ...
            using (FastSerializer serialiser = new FastSerializer())
            {
                return serialiser.Serialize(dataTable);
            }
		}
		...
		public static byte[] SerializeSimpleTypedDataTable(DataTable dataTable)
		{
            ...
            using (FastSerializer serialiser = new FastSerializer())
            {
                return serialiser.SerializeSimpleDataOnly(dataTable);
            }
		}
		...
		public static DataSet DeserializeTypedDataSet(Type dataSetType, byte[] serializedData)
		{
            ...
            using (FastDeserializer deserialiser = new FastDeserializer())
            {
                return deserialiser.DeserializeDataSetDataOnly(dataSet, serializedData);
            }
		}
		...
		public static DataTable DeserializeTypedDataTable(Type dataTableType, byte[] serializedData)
		{
            ...
            using (FastDeserializer deserialiser = new FastDeserializer())
            {
                return deserialiser.DeserializeDataTableDataOnly(DataTable, serializedData);
            }
		}
		...
		public static DataSet DeserializeDataSet(byte[] serializedData)
		{
            ...
            using (FastDeserializer deserialiser = new FastDeserializer())
            {
                return deserialiser.DeserializeDataSet(new DataSet(), serializedData);
            }
		}
		...
		public static DataSet DeserializeDataSet(DataSet dataSet, byte[] serializedData)
		{
            ...
            using (FastDeserializer deserialiser = new FastDeserializer())
            {
                return deserialiser.DeserializeDataSet(dataSet, serializedData);
            }
		}
		...
		public static DataTable DeserializeDataTable(DataTable dataTable, byte[] serializedData)
		{
            ...
            using (FastDeserializer deserialiser = new FastDeserializer())
            {
                return deserialiser.DeserializeDataTable(dataTable, serializedData);
            }
		}
		...
		public static DataTable DeserializeSimpleTypedDataTable(DataTable dataTable, byte[] serializedData)
		{
            ...
            using (FastDeserializer deserialiser = new FastDeserializer())
            {
                return deserialiser.DeserializeSimpleTypedDataTable(dataTable, serializedData);
            }
		}
        ...
        private static readonly int ColumnHasAutoIncrementNegativeStep = BitVector32.CreateMask(ColumnHasAutoIncrement);
		...
		#region Serializer
		private class FastSerializer: IDisposable
		{
		...
		#region Deserializer
		private class FastDeserializer: IDisposable
		{
