...
namespace sc2i.data.serveur
{
	...
	/// </summary>
	public class CFormatteurFiltreDataToStringOracle : IFormatteurFiltreDataToString
	{
        private const string c_null = "LAVARIABLEVAUTNULL";

        private COracleDatabaseConnexion m_connexion = null;
		...
		public string GetStringAvance ( CFiltreDataAvance filtre )
		{
            ...
            return GetStringExpression(composant, filtre, valeursParametres);
		}
