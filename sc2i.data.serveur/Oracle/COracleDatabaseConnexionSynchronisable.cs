...
namespace sc2i.data.serveur
{
	...
	/// </summary>
	public class COracleDatabaseConnexionSynchronisable : COracleDatabaseConnexion, IDatabaseConnexionSynchronisable
	{
		...
		/// /////////////////////////////////////////////////////
		public COracleDatabaseConnexionSynchronisable(int nIdSession)
			: base(nIdSession)
		{
		}
		...
		{
			return (IDataBaseCreator)new COracleDataBaseCreatorSynchronisable(this);
		}
