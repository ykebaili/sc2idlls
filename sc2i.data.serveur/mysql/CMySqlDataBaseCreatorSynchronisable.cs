...
{
	public class CMySqlDataBaseCreatorSynchronisable : CMySqlDataBaseCreator
	{
		//------------------------------------------------------------------------------------------------
		public CMySqlDataBaseCreatorSynchronisable(CMySqlDatabaseConnexionSynchronisable connexion)
			:base(connexion)
		{
		}
