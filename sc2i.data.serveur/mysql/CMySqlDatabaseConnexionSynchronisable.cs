...
namespace sc2i.data.serveur
{
	...
	/// </summary>
	public class CMySqlDatabaseConnexionSynchronisable : CMySqlDatabaseConnexion, IDatabaseConnexionSynchronisable
	{
		...
		/// /////////////////////////////////////////////////////
		public CMySqlDatabaseConnexionSynchronisable(int nIdSession)
			: base(nIdSession)
		{
		}
		...
		{
			return (IDataBaseCreator)new CMySqlDataBaseCreatorSynchronisable(this);
		}
		...
		/// </summary>
		public int LastVersionVueDeBasePrincipale
		{
			get
			{
				if (!IsInTrans())
		...
		/// Retourne l'id de dernière synchro depuis la base principale
		/// </summary>
		public int LastSyncIdPutInMain
		{
			get
			{
				if (!IsInTrans())
		...
		//    return new C2iMySqlAdapterBuilderForTypeSynchronisable(leType, this);
		//}
