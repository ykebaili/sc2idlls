...
namespace sc2i.expression.expressions
{
	...
	/// </summary>
	[Serializable]
	public class C2iExpressionOU : C2iExpressionAnalysable
	{
		/// //////////////////////////////////////////
		public C2iExpressionOU()
		{
		}
        ...
        public override CInfo2iExpression GetInfos()
        {
            ...
            if (Parametres.Count > 0 && Parametres2i[0] != null)
		...
		{
			CInfo2iExpression info = new CInfo2iExpression(5, "or", typeof(bool), I.TT(GetType(), "Logical operator OR|249"), CInfo2iExpression.c_categorieLogique);
