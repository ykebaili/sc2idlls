...
namespace sc2i.expression.expressions
{
	...
	/// </summary>
	[Serializable]
	public class C2iExpressionMoins : C2iExpressionAnalysable
	{
		/// //////////////////////////////////////////
		public C2iExpressionMoins()
		{
		}
		...
		{
			CInfo2iExpression info = new CInfo2iExpression(2, "-", typeof(double), I.TT(GetType(), "Operator substraction|265"), CInfo2iExpression.c_categorieMathematiques);
