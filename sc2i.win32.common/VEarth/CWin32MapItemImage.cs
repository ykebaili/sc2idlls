...
{
    [AutoExec("Autoexec")]
    public class CWin32MapItemImage : GMarkerGoogle, IWin32MapItem
    {
        private IMapItem m_item = null;
        //------------------------------------------------------------------
        public CWin32MapItemImage(CMapItemImage item)
        ...
        {
            CAllocateurWin32MapItem.RegisterMarker(typeof(CMapItemImage), typeof(CWin32MapItemImage));
        }
