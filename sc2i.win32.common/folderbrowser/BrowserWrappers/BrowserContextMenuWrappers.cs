...
namespace sc2i.win32.common.folderbrowser
{
    ...
    internal class BrowserTVContextMenuWrapper : NativeWindow
    {
        ...
        public BrowserTVContextMenuWrapper(CFileExplorer br)
        {
            this.br = br;
    ...
    internal class BrowserLVContextMenuWrapper : NativeWindow
    {
        ...
        /// </summary>
        /// <param name="br">The browser for which to support the ContextMenu</param>
        public BrowserLVContextMenuWrapper(CFileExplorer br, BrowserPluginWrapper pluginWrapper)
        {
            this.br = br;
    ...
    internal static class ContextMenuHelper
    {
        ...
        /// Ctrl + C and Ctrl + V.
        /// </summary>
        public static void ProcessKeyCommands(CFileExplorer br, object sender, KeyEventArgs e)
        {
