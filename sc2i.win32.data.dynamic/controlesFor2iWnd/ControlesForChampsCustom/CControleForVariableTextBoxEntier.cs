...
{
	public class CControleForVariableTextBoxEntier : C2iTextBoxNumerique, IControleForVariable
	{
		...
		//--------------------------------------------------
		public CControleForVariableTextBoxEntier()
		{
			DecimalAutorise = false;
			Arrondi = 0;
			NullAutorise = true;
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            this.SuspendLayout();
            // 
            // CControleForVariableTextBoxEntier
            // 
            this.Validated += new System.EventHandler(this.CControleForVariableTextBoxEntier_TextChanged);
            this.ResumeLayout(false);

        }

        private void CControleForVariableTextBoxEntier_TextChanged(object sender, EventArgs e)
        {
