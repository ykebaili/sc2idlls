...
{
	[AutoExec("Autoexec")]
	public class CFormEditActionErreur : sc2i.win32.process.CFormEditObjetDeProcess
	{
		...
		{
			CEditeurActionsEtLiens.RegisterEditeur ( typeof(CActionErreur), typeof(CFormEditActionErreur));
		}


		public CActionErreur ActionErreur
		{
			get
			{
				return (CActionErreur)ObjetEdite;
			}
		}
		...
		private void InitializeComponent()
		{
            ...
            // 
            // CFormEditActionErreur
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(560, 326);
            this.Controls.Add(this.panel2);
            this.Name = "CFormEditActionErreur";
            this.Text = "Error generation|123";
            this.Load += new System.EventHandler(this.CFormEditActionErreur_Load);
		...
		protected override sc2i.common.CResultAErreur MAJ_Champs()
		{
			...
			if ( !result )
				return result;
			ActionErreur.FormuleMessage = (C2iExpression)result.Data;
			return result;
		}
		...
		protected override void InitChamps()
		{
			...
			if ( ActionErreur.FormuleMessage != null )
			{
				m_txtFormule.Text = ActionErreur.FormuleMessage.GetString();
			}
		}
        ...
        private void CFormEditActionErreur_Load(object sender, EventArgs e)
        {
