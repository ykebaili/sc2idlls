...
{
	[AutoExec("Autoexec")]
	public class CFormEditActionEtiquetterBase : sc2i.win32.process.CFormEditObjetDeProcess
	{
		...
		public CFormEditActionEtiquetterBase()
		{
		...
		public CActionEtiquetterBase ActionEtiquetterBase
		{
			get
			{
				return (CActionEtiquetterBase)ObjetEdite;
			}
		}
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Stamp label|20001";
			// 
			// m_wndAideFormule
			// 
			...
			// 
			// CFormEditActionEtiquetterBase
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(560, 326);
			this.Controls.Add(this.panel2);
			this.Name = "CFormEditActionEtiquetterBase";
			this.Text = "Stamp the database|20000";
			this.Load += new System.EventHandler(this.CFormEditActionEtiquetterBase_Load);
		...
		protected override sc2i.common.CResultAErreur MAJ_Champs()
		{
			...
			if ( !result )
				return result;
			ActionEtiquetterBase.FormuleLibelle = (C2iExpression)result.Data;
			return result;
		}
		...
		protected override void InitChamps()
		{
			...
			if ( ActionEtiquetterBase.FormuleLibelle != null )
			{
				m_txtFormule.Text = ActionEtiquetterBase.FormuleLibelle.GetString();
			}
		}
        ...
        private void CFormEditActionEtiquetterBase_Load(object sender, EventArgs e)
        {
