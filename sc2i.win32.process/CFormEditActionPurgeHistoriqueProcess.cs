...
{
	[AutoExec("Autoexec")]
	public class CFormEditActionPurgeHistoriqueProcess : sc2i.win32.process.CFormEditObjetDeProcess
	{
		...
		public CFormEditActionPurgeHistoriqueProcess()
		{
		...
		public CActionPurgeHistoriqueProcess ActionPurger
		{
			get
			{
				return (CActionPurgeHistoriqueProcess)ObjetEdite;
			}
		}
		...
		private void InitializeComponent()
		{
			...
			// 
			// CFormEditActionPurgeHistoriqueProcess
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(584, 398);
			this.Controls.Add(this.panel2);
			this.Name = "CFormEditActionPurgeHistoriqueProcess";
			this.Text = "Clear process history|20005";
			this.Load += new System.EventHandler(this.CFormEditActionPurgeHistoriqueProcess_Load);
		...
		private void CFormEditActionPurgeHistoriqueProcess_Load(object sender, System.EventArgs e)
		{
