...
{
	[AutoExec("Autoexec")]
	public class CFormEditActionSetModificationContextuelle : sc2i.win32.process.CFormEditObjetDeProcess
	{
		...
		public CFormEditActionSetModificationContextuelle()
		{
		...
		public CActionSetModificationContextuelle ActionSetModificationContextuelle
		{
			get
			{
				return (CActionSetModificationContextuelle)ObjetEdite;
			}
		}
		...
		private void InitializeComponent()
		{
            ...
            this.label1.Text = "Contexte|20029";
            // 
            // m_wndAideFormule
            // 
            ...
            // 
            // CFormEditActionSetModificationContextuelle
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(560, 326);
            this.Controls.Add(this.panel2);
            this.Name = "CFormEditActionSetModificationContextuelle";
            this.Text = "Change modification context|20028";
            this.Load += new System.EventHandler(this.CFormEditActionSetModificationContextuelle_Load);
		...
		protected override sc2i.common.CResultAErreur MAJ_Champs()
		{
			...
			if ( !result )
				return result;
			ActionSetModificationContextuelle.FormuleContexte = (C2iExpression)result.Data;
			return result;
		}
        ...
        private void CFormEditActionSetModificationContextuelle_Load(object sender, EventArgs e)
        {
